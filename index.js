...
/***/ function(module, exports, __webpack_require__) {
	...
	var _arrayMethod = __webpack_require__(175);
	...
	var App = function (_Component) {
	    ...
	    function App() {
	        ...
	        _this.state = {
	            resizable: false,
	            items: [{ id: 1, width: 50, height: 50 }, { id: 2, width: 50, height: 50 }, { id: 3, width: 50, height: 50 }]
	        };

	        _this.methods = {
	            shuffle: function shuffle() {
	                return _this.setState({ items: (0, _arrayMethod.shuffle)(_this.state.items) });
	            },
	            remove: function remove() {
	                return _this.setState({ items: (0, _arrayMethod.remove)(_this.state.items, 0 | Math.random() * 100) });
	            },
	            rotate: function rotate() {
	                return _this.setState({ items: (0, _arrayMethod.rotate)(_this.state.items) });
	            },
	            rotateBack: function rotateBack() {
	                return _this.setState({ items: (0, _arrayMethod.rotateBack)(_this.state.items) });
	            },
	            add: function add() {
	                return _this.setState({
	                    items: (0, _arrayMethod.add)(_this.state.items, {
	                        id: _this.state.items.reduce(function (max, item) {
	                            return Math.max(item.id, max);
	                        }, 1) + 1,
	                        width: 50,
	                        height: 50
	                    })
	            ...
	            resize: function resize(id, size) {
	                return _this.setState({
	                    items: _this.state.items.map(function (item) {
	                        return item.id == id ? _extends({}, item, size) : item;
	                    })
	                });
	            },

	            setResizable: function setResizable(resizable) {
	                return _this.setState({ resizable: resizable });
	            },
	            randomSize: function randomSize() {
	                return _this.setState({
	                    items: _this.state.items.map(function (x) {
	                        return _extends({}, x, {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_menu2.default, _extends({}, this.methods, { resizable: this.state.resizable })),
	                _react2.default.createElement(_list2.default, _extends({}, this.state, { resize: this.state.resizable && this.methods.resize }))
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var List = function List(_ref) {
	    ...
	    return _react2.default.createElement(
	        _index2.default,
	        { style: style.list, className: 'list', childClassName: 'item', childStyle: style.item, stiffness: 0.01, damping: 0.15 },
	        function () {
	            return items.map(function (x) {
	                return _react2.default.createElement(_item2.default, _extends({ key: x.id }, x, { resize: resize }));
	            });
	        }
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _computeMotion = __webpack_require__(171);
	...
	var transform = function transform(_ref) {
	    ...
	    var value = "translate3d(" + x + "px, " + y + "px, 0) translate3d(" + -50 * (1 - sx) + "%, " + -50 * (1 - sy) + "%,0) scale(" + sx + "," + sy + ") ";
	    return {
	        transform: value,
	...
	var Flippity = function (_Component) {
	    _inherits(Flippity, _Component);

	    function Flippity() {
	        _classCallCheck(this, Flippity);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Flippity).call(this));
	    ...
	    _createClass(Flippity, [{
	        key: "step",
	        value: function step() {

	            var animationRunning = false;
	            var positions = this.state.positions;
	            var velocities = this.state.velocities;

	            var precision = this.props.precision || 0.1;
	            var stiffness = this.props.stiffness || 0.01;
	            var damping = this.props.damping || 0.15;

	            // for each item, step the position
	            for (var key in positions) {

	                var v = velocities[key];
	                var p = positions[key];

	                // compute the acceleration on the x axis ( the position target is 0,0 )
	                v.x += (0, _computeMotion.acc)(stiffness, damping, p.x, v.x, 0);
	                v.y += (0, _computeMotion.acc)(stiffness, damping, p.y, v.y, 0);
	                v.sx += (0, _computeMotion.acc)(stiffness, damping, p.sx, v.sx, 1);
	                v.sy += (0, _computeMotion.acc)(stiffness, damping, p.sy, v.sy, 1);
	                ...
	                animationRunning = animationRunning || !(0, _computeMotion.cold)(precision, p, { x: 0, y: 0, sx: 0, sy: 0 }, v);
	            }
	        ...
	        key: "computeStartingPosition",
	        value: function computeStartingPosition() {
	            this.source = {};

	            for (var key in this.refs) {

	                var box = this.refs[key].getBoundingClientRect();
	        ...
	        key: "computeTargetPosition",
	        value: function computeTargetPosition() {
	            ...
	            for (var key in this.refs) {
	                ...
	                var origin = { x: box.left, y: box.top, width: box.width || 1, height: box.height || 1 };
	            ...
	            this.setState({ positions: positions, velocities: velocities });
	        }
	    }, {
	        ...
	        value: function componentWillUpdate(nextProps, nextState) {
	            if (this.shouldMesure) requestAnimationFrame(this.componentHaveRender.bind(this));
	        }
	    }, {
	        key: "componentHaveRender",
	        value: function componentHaveRender() {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                renderedChildren.map(function (child) {
	                    return _react2.default.createElement(
	                        "div",
	                        {
	                            ...
	                            key: child.key,
	                            ref: child.key,
	                            className: _this2.props.childClassName,
	                            style: _extends({}, _this2.props.childStyle || {}, _this2.shouldMesure || !_this2.state.animationRunning ? {} : transform(_this2.state.positions[child.key] || { x: 0, y: 0, sx: 1, sy: 1 }))
	                        },
	                        child
	                    );
	                })
...
/***/ function(module, exports) {
	...
	var acc = exports.acc = function acc(k, b, x, v, target) {
	    return -k * (x - target) - b * v;
	};

	var cold = exports.cold = function cold(precision, p, target, v) {
	    return Math.abs(v.x) < precision && Math.abs(v.y) < precision && Math.abs(v.sx) < precision && Math.abs(v.sy) < precision && Math.abs(p.x - target.x) < precision && Math.abs(p.y - target.y) < precision && Math.abs(p.sx - target.sx) < precision && Math.abs(p.sy - target.sy) < precision;
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var color = ['#243123', '#ab423e', '#3eab42', '#d49e24', '#796026', '#267975'];
	var Item = function Item(_ref) {
	    ...
	    return _react2.default.createElement(
	        'div',
	        { style: _extends({}, style.item, {
	                width: width,
	                height: height,
	                backgroundColor: color[id % color.length]
	            }) },
	        resize && _react2.default.createElement('input', { style: style.bar, type: 'range', min: 36, max: 200, step: 1, onChange: function onChange(event) {
	                return resize(id, { width: +event.target.value });
	            } }),
	        resize && _react2.default.createElement('input', { style: style.bar, type: 'range', min: 36, max: 200, step: 1, onChange: function onChange(event) {
	                return resize(id, { height: +event.target.value });
	            } })
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Menu = function Menu(_ref) {
	    ...
	    var rotateBack = _ref.rotateBack;
	    var randomSize = _ref.randomSize;
	    var setResizable = _ref.setResizable;
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { type: 'checkbox', checked: resizable, onChange: function onChange(event) {
	                return setResizable(event.target.checked);
	            } })
	    );
	};
...
/***/ function(module, exports) {
	...
	var rotate = exports.rotate = function rotate(a) {
	    return a.length == 0 ? [] : [].concat(_toConsumableArray(a.slice(1)), [a[0]]);
	};

	var rotateBack = exports.rotateBack = function rotateBack(a) {
	    return a.length == 0 ? [] : [a[a.length - 1]].concat(_toConsumableArray(a.slice(0, -1)));
	};

	var remove = exports.remove = function remove(a) {
	...
	var add = exports.add = function add(a, x) {
